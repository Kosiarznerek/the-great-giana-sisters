class Diamencik extends Prostokat {
    ...
    private _poczatkowaPozycja: Wektor;
    private _wLocie: boolean;

    private _kierunek: Wektor;
    private _predkosc: number;
    private _maxWysokosc: number;
    ...
    public aktualizujPozycje(): void {
        ...
        //Aktualizuje pozycje
        const w: Wektor = Wektor.PomnozSkalarnie(this._kierunek, this._predkosc);
